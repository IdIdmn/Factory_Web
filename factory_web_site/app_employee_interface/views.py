...
def orders_list(request):
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            if search_column == "date_interval" or search_column == "cost":
                ...
                request_params[search_column] = form.cleaned_data.get("common_text")
    ...
    return render(request, "table-page.html", {"form": form, "title": "Список заказов", "model": orders, "empty_table_phrase" : empty_table_phrase, "sort_direction": change_direction(sort_direction),
     "request_params": request_params, "table_column_titles": Order.get_fields_values_titles(), "model_field_titles":Order.get_fields_titles_ru_en_dict()})
